...
import Sdet_27.GenericUtility.BaseApiClass;
import Sdet_27.GenericUtility.EndPoints;
...
public class CreateResourcesandVerifyIndataBase extends BaseApiClass{
	...
	public void createresourceAndVerifyDb() throws SQLException {
		...
		PojoClass pLib=new PojoClass("nadesh", "nykee"+jlib.getRandomNum(), "completed", 42);
